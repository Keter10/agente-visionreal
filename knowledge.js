...
export const MODELS = [
  {
    ...
    precio_usd: 11500,
    ficha_pdf: 'https://visionreal.com.ar/fichas/vr-studio-15.pdf',
  },
  {
    id: 'vr-compact-20',
    nombre: 'VR Compact 20',
    m2: 20,
    ambientes: '1 ambiente amplio + baño',
    descripcion: 'Diseño optimizado para máximo aprovechamiento del espacio.',
    precio_usd: 14800,
    ficha_pdf: 'https://visionreal.com.ar/fichas/vr-compact-20.pdf',
  },
  {
    id: 'vr-starter-25',
    nombre: 'VR Starter 25',
    m2: 25,
    ambientes: '2 ambientes',
    descripcion: 'Primera vivienda propia con ambientes bien diferenciados.',
    precio_usd: 18200,
    ficha_pdf: 'https://visionreal.com.ar/fichas/vr-starter-25.pdf',
  },
  {
    id: 'vr-basic-30',
    nombre: 'VR Basic 30',
    m2: 30,
    ambientes: '2 ambientes',
    descripcion: 'Vivienda básica con buena distribución para pareja o persona sola.',
    precio_usd: 21500,
    ficha_pdf: 'https://visionreal.com.ar/fichas/vr-basic-30.pdf',
  },
  {
    id: 'vr-essential-35',
    nombre: 'VR Essential 35',
    m2: 35,
    ambientes: '2 ambientes + baño completo',
    descripcion: 'Confort esencial con baño completo y cocina separada.',
    precio_usd: 24800,
    ficha_pdf: 'https://visionreal.com.ar/fichas/vr-essential-35.pdf',
  },
  {
    id: 'vr-comfort-40',
    nombre: 'VR Comfort 40',
    m2: 40,
    ambientes: '2 ambientes + baño + estar',
    descripcion: 'Zona de estar diferenciada para mayor comodidad familiar.',
    precio_usd: 28200,
    ficha_pdf: 'https://visionreal.com.ar/fichas/vr-comfort-40.pdf',
  },
  {
    id: 'vr-family-45',
    nombre: 'VR Family 45',
    ...
    descripcion: 'Pensada para familia pequeña con cocina integrada al comedor.',
    precio_usd: 31500,
    ficha_pdf: 'https://visionreal.com.ar/fichas/vr-family-45.pdf',
  },
  {
    id: 'vr-plus-50',
    nombre: 'VR Plus 50',
    m2: 50,
    ambientes: '2 dormitorios + 2 baños',
    descripcion: 'Dos baños completos para mayor independencia en el hogar.',
    precio_usd: 34800,
    ficha_pdf: 'https://visionreal.com.ar/fichas/vr-plus-50.pdf',
  },
  {
    id: 'vr-standard-55',
    nombre: 'VR Standard 55',
    m2: 55,
    ambientes: '3 dormitorios + baño',
    descripcion: 'Tres dormitorios ideales para familia con hijos.',
    precio_usd: 38200,
    ficha_pdf: 'https://visionreal.com.ar/fichas/vr-standard-55.pdf',
  },
  {
    id: 'vr-premium-60',
    nombre: 'VR Premium 60',
    m2: 60,
    ambientes: '3 dormitorios + 2 baños',
    descripcion: 'Amplitud y confort con doble baño para toda la familia.',
    precio_usd: 41500,
    ficha_pdf: 'https://visionreal.com.ar/fichas/vr-premium-60.pdf',
  },
  {
    id: 'vr-superior-65',
    nombre: 'VR Superior 65',
    m2: 65,
    ambientes: '3 dormitorios + 2 baños + estar',
    descripcion: 'Living separado del comedor para mayor comodidad.',
    precio_usd: 44800,
    ficha_pdf: 'https://visionreal.com.ar/fichas/vr-superior-65.pdf',
  },
  {
    id: 'vr-executive-70',
    nombre: 'VR Executive 70',
    m2: 70,
    ambientes: '3 dormitorios + 2 baños + estar + lavadero',
    descripcion: 'Lavadero independiente y espacios bien diferenciados.',
    precio_usd: 48200,
    ficha_pdf: 'https://visionreal.com.ar/fichas/vr-executive-70.pdf',
  },
  {
    id: 'vr-deluxe-75',
    nombre: 'VR Deluxe 75',
    m2: 75,
    ambientes: '3 dormitorios + 2 baños + sala + comedor',
    descripcion: 'Sala y comedor separados para una vida familiar cómoda.',
    precio_usd: 51500,
    ficha_pdf: 'https://visionreal.com.ar/fichas/vr-deluxe-75.pdf',
  },
  {
    id: 'vr-grand-80',
    nombre: 'VR Grand 80',
    ...
    descripcion: 'Cuatro dormitorios para familias numerosas.',
    precio_usd: 54800,
    ficha_pdf: 'https://visionreal.com.ar/fichas/vr-grand-80.pdf',
  },
  {
    id: 'vr-elite-85',
    nombre: 'VR Elite 85',
    m2: 85,
    ambientes: '4 dormitorios + 2 baños + sala',
    descripcion: 'Sala amplia y 4 dormitorios para el máximo confort.',
    precio_usd: 58200,
    ficha_pdf: 'https://visionreal.com.ar/fichas/vr-elite-85.pdf',
  },
  {
    id: 'vr-prestige-90',
    nombre: 'VR Prestige 90',
    m2: 90,
    ambientes: '4 dormitorios + 3 baños',
    descripcion: 'Tres baños completos para una familia de alto estándar.',
    precio_usd: 61500,
    ficha_pdf: 'https://visionreal.com.ar/fichas/vr-prestige-90.pdf',
  },
  {
    id: 'vr-maxi-103',
    nombre: 'VR Maxi 103',
    ...
    precio_usd: 70400,
    ficha_pdf: 'https://visionreal.com.ar/fichas/vr-maxi-103.pdf',
  },
];
